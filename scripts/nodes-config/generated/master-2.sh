#!/bin/bash
# ==========================================
# Master-2 Setup Template
# ==========================================
# এই স্ক্রিপ্ট মাস্টার-২ নোড কনফিগার করে (Join Control Plane)।
# This script configures the Master-2 node (Join Control Plane).
#
# Usage: Generated by automate-node-config.shed from template - DO NOT EDIT MANUALLY
